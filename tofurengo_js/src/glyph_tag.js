...
/**
 * Simplifies text containing GlyphTags by stripping tag attributes.
 *
 * @param {string} text - Input text containing GlyphTags.
...
/**
 * Normalizes GlyphTags within the provided raw input text using a specified dataset table.
 *
 * @param {string} text - Raw input text containing GlyphTags to normalize.
...
/**
 * Renders text containing normalized GlyphTags directly into Unicode character strings.
 *
 * @param {string} text - Input text containing normalized or raw GlyphTags.
 ...
 *
 * @param {string} text - Raw input text containing GlyphTags.
